(function() {
  var GameObject, GravityBall, LevelCanvas, LevelListing, LevelModel, Paddle, c, gameObjectClassByName, gameObjectClasses, layoutGameObjects;
  ...
  LevelListing = (function() {
    function LevelListing(dom, levelModel) {
      this.dom = dom;
      this.levelModel = levelModel;
      this.redraw = __bind(this.redraw, this);
      this.clear = __bind(this.clear, this);
      this.$dom = $(this.dom);
      $(this.dom).html("<li>No objects...</li>");
    ...
    LevelListing.prototype.redraw = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        gameObject = _ref[_i];
        _results.push(this.$dom.append($("<li class='listingObject" + (gameObject.selected ? ' selected' : '') + "' data-id='" + gameObject.id + "'>" + (gameObject.getClass().name) + " @ " + gameObject.x + "</li>")));
      }
      return _results;
    };
    return LevelListing;
  ...
  $(document).ready(function() {
    var canvas, iphoneWidth, levelCanvas, levelListing, levelModel;
    layoutGameObjects();
    iphoneWidth = 480;
